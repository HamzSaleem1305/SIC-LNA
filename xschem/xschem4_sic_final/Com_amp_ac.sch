...
N 490 50 520 50 { lab=Vi}
N 130 170 130 300 { lab=Vi}
N 130 300 520 300 { lab=Vi}
N 520 50 520 300 { lab=Vi}
...
N -510 160 -510 170 { lab=#net4}
N 200 -130 240 -130 { lab=GND}
N 240 -130 240 -70 { lab=GND}
N 180 -100 180 -80 { lab=Vo1n}
N 180 -60 180 -10 { lab=Vo1n}
N -230 230 -170 230 { lab=#net5}
...
N -360 160 -290 160 { lab=#net8}
N -230 160 -130 160 { lab=Vi}
N -510 160 -420 160 { lab=#net4}
N 330 70 330 120 {
lab=Vo1nn}
...
C {devices/vsource.sym} -510 200 0 0 {name=VIN1 value="0 ac 1m"}
...
device=resistor
m=1}
C {sky130_fd_pr/res_high_po_0p69.sym} 180 -130 0 1 {name=R13
W=0.69
L=0.69
...
C {devices/res.sym} -130 -190 0 0 {name=R2
value=1000
footprint=1206
device=resistor
m=1}
...
#spectrum 1000MEG 5000MEG 100MEG v(VI) 
#let abc=spectrum 1000MEG 5000MEG 100MEG v(VI) 
#plot db(abc)
ac dec 100 1e9 10e9
plot db(v(Vo1p)/v(VI))
plot db(v(Vo2)/v(VI))
